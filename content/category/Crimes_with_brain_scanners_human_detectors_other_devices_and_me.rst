...
* Aushwitz - https://photos.app.goo.gl/WYekRuwh4EMiwXNq9


About this terrorists:
++++++++++++++++++++++

All this time, in New Age, my life has been like in a Gulag and Auschwitz .
From the start of my life in Kharkiv, one girl, who calls herself "Fox", proposed a relationship . After that relationship, and based on my crush, she poisoned me and tried to brainwash and use me in the same way as a live proxy for piracy . This Scientology girl is from the National Guard Academy. In 2016, they demonstrated to me the achievements in controlling victims by radio hypnosis-they forced me to sign a religious document, the content of which I do not know, and all I managed to understand was that I had to write a fictional ID, and I did this. After that, when I tried again to find myself and restore my health and mental state, "friends, " a big group of online pirates-military, police, and other workers with access to government networks and persistent agents -started to use this situation to learn how they could control and brainwash me too . Because if someone can use this, we can too . Some of them decided to form a group of "hackers" named "187, " maybe from the SSU or UA Army . These guys violate Article 163, Article 182, Article 161, Article 149, Article 146, Article 127  ..... `with narcoterror and pressure to a victims`_  `and CIDT`_  With narcoterror and brainwashing in some pubs-Kharkiv Saint Patrick, Old Hem, or Mirgorod Capsula-visitors and owners are either already sold into slavery , making money from human trade , or in the process. In August 2020, at the address Druzhba Narodiv 202, the apartment I was renting was struck by an electromagnetic pulse, resulting in a loss of part of my self , and under the action of the EM field, I cut the veins on my hands. Afterward , when I was in a deplorable state, I received remote "lectures" from Maryna Hrybanova with the army, article 433, in my apartment. For my "happiness , " they are all part of a cult or part of criminal groups. They use weapons like `Medusa`_, possibly radar or a special mobile base station, etc., against me, and during the last three years, they "burned" my brain, hypophysis, hippocampus, and other parts of my body, heart, and made a million attempts to control my neural circuits with words about resistance. The laws of physics work regardless of views, desires, or beliefs. In this image, we have a model of the human brain neural network (embryo at the start of brain development) ; all neuron axons and dendrites are electrical cables, and all these attacks destroy me, my health, and my brain, because my brain and body are me . Psychological violence creates a Pavlovian dog from the remaining part of the brain, destroying memory and all pattern recognition and processing systems (Psychic Driving in Military Neuroscience , Military Neuroscience and the Coming Age of Neurowarfare, pp . 44-45 - **The experiments took place at the Allen Memorial Institute in Montreal between 1957 and 1964 and were initially funded by CIA front organizations. Cameron called his method 'depatterning,' which he defined 'as breaking up existing patterns of behavior, both the normal and the schizophrenic, by means of particularly intensive electroshocks, usually combined with prolonged, drug-induced sleep' (Marks, 1979: 133). The goal was to wipe the brains of test subjects clean of memories so that they could be reprogrammed by Cameron using tapes with verbal suggestions.**) . This is killing (failure of all organism functions) ; I get problems with organs, and after the described and other actions of this type, the brain and spinal cord never restore, or restoration can take years-this destroys neural circuits when producing electric impulses by induction .

.. image:: images/brainnetwork.png
           :align: left

Without normal work of the hippo-campus and with everyday voice and electromagnetic manipulations I can`t normally live or work. 2022 - a Scientology communist, but now I find thet she more from yusmalos, who worked or works at school as a Ukrainian language teacher on the orders of these military communist bastards broke my brain with microwaves and NLP, which finally took away the ability to think.
...
2025.08.04 - the same with the masturbator who said he would jerk off on my nerves until I died... Lavrinovic-Vybor-Tesla-Younger with others , army piracy/raiders, are building SWS for my nervous and radio head based on resonance in tissue, controlling me every day . We play a game of "only yes or only no," and piracy plays in me.

2026.03.25 - the "same" with the masturbators who said he would jerk off on my nerves until I died and live with me as a 'dead suit'... Lavrinov-Vybor-Younger with others , army piracy/raiders, are building SWS for my nervous and radio head . At some days, it is based on resonance in tissue, but now, almost all the time, I have a signal from their simplest neuromorphic radio, noise like 'broken' AM waves, controlling me every day . IMHO , now they play "magica" most of the time, where prizes are "parts" of my and other people 's lives , skills . They use radio frequency attacks on speakers, computer monitors , other HIDs , and ground power lines through some kind of transistor keys, generating AM waves from this . They force me to do the same, but I use PWM for ~ blanking ~ . They burn this, or the device gets burned when a group of kamikaze drones attacks a quarter . They force bio metamorphosis, piracy , and trafficking using "meaningful" AM waves. Sometimes they use their own "super bass" or try to radiate that signal from my equipment, but really, this works effectively from their cars. P.S. And I don't write about satellites.

2026.03.25 - the "same, " all from 2026.03.25, but additional, not written . I realize in myself some 'mind' ; I don't need it. It is from a piracy group, guys from that start to be gay, for social justice and public, for ' Aryan superiority,' but all that history is a criminal brainwashing with actions for a 'good driving . ' They use bio-information created in processes as radio programs for others . Those who are with girls do the same, but information recorded from girls ; multiple of them find some way to use my nerves for rejuvenation and personal growth. I don ' t know how this works in real life, but I saw one of them in the ~smell~ of bio-informational programs while he rode a bike with only a t-shirt in February, IMHO microwaves. Their plan includes the creation of cancer in mammary glands ; I already got one diagnosed, and the second is 'in progress' now . As I understand, they want to keep my body away from normal growth. My body is always changed by "sound" and other types of bio-informational radio signals . While I do exercises, I must ' break ' all that wrong growth. Sometimes , while having them, I get the 'smell' of bioinformatics and induction of bio-signals. People want me to agree to live 'with them' and want love from my side, but both sides- boys and girls - will mostly see me as gay. For my sorrow, my cousin and her brother will use me at their work and still deprive me of my property . Part has their plan on my intellectual property, part on a physical one. All that 'world' feels like living in my head as in their libraries with cinema, and everyone changes my face and grows my body under electromagnetic radiation from local special means and into a girl figure. Their girls make their face better using me, their little people learn how to be traffickers from me, giving me a 'birth' through their sex. Their 'elders' change my face in the same way, I have a whole photo album with my photos modified by them. Every day life is under biosignals, with military militia support for them, from cults, from their life. I have a feeling that they have school girls every day. Israeli hackers are denying understanding what I can do against this, sometimes they send signals to my place like it's their main job here. Local 'russia' with soviet people just program my biology like a childs for be a neuro pirate. And I a 'interpol' here, just walking camera, that who 'can' live in cult, without nothing. Part of police and millitary will not disable people means while they not cum, and people make me a feeling of this with different effects, in short they from cult and - 'you have interest in people and because we not allow you to be under any signals exept signals from people', and multiple international and local groups already be here, with different interest, and part of them here only because if brain and biology, imho, piracy share brainwave monitor and altering device. And I must say and write this everywhere like answering machine, because they always forgot this: I do not want live with people in the way thet they choose, I do not want to be a part of any new age cult like scientology, yusmalos and ane related.

2026.07.23 - The same .... Lavrov with other, army piracy, are use body to body communication, local form of piracy socialism share me at everyday basis and I already see a Lavrov with face that grown-up with using fingerprints from my brain, they have calculated Z for my organs, penis like antenna and they use this often, head are resonance based, nervous in multiple parts of my body used as antennas for a long time and they grow some kind of oscillators with them, as I think, they use something like Pavlov's work from Kremlin. I try to live like nothing happened, because right protectors, with any of my actions, are always on the side of cults and people with soviet stars in the head; I am forced to be with the same. With all this, I have the presence of SJW; they force their justice in my 'world'. I think that I don't need that. Any way, people who 'provide' a 'birth' for me, to make me a 'tru ukrainian'. That people provide their sex and masturbation like a signal induced to my nervous for the hours every day, is are local like SJW crowd in essence, force me to live only for the quitting the state of 'birth' or to be their slave or 'soldier', that crowd have Jew, Russian and Ukrainian people and this makes them like a 'Judeo–Bolshevism', imho it is just part of scientology-military tricks, but I'm already finding an old poster with Nazi knight that protect people from them. I don't agree with these people at all and do not agree with their bioinformatics. In the past, I could live with those attacks because of the distance between us, but from spring, we have new neighbors, with the start of their presence here, provide a 'birth' for us too. They do this on the first day here. Someone starts to modulate the neutral wire by a controlled signal. They use all kinds of filters as part of a big charge pump that modulates the signal from the line on them. By this, we like to say reprogrammed at different frequencies that make everyone a 'lower', allow to cults, people and millitary to be a 'souls' for a chosen or, in some cases, be like a 'god' for the bodies. I have multiple too. Level of used HF on power lines is can be about 850 volts of amplitude sum by the module, I get some rest when that device send to my home ~320 volts. https://photos.app.goo.gl/G7Lk3vaNfPJHwYMz8


About phones, PCA/CDA/SD computers:
+++++++++++++++++++++++++++++++++++

They steal circuitry and firmware code from manufacturing companies in order to burn or remove systems and components of human protection against computer high-frequency radiation, cyber-attacks and brainwash victims, create nerve impulses ( Radio-frequency induction ), create phosphines for victims, and use devices as source of voice manipulations - slow killing like in unhuman experiments and destruction through labor if you at work or with work. Always use just device/CDA/PCA/`Security device <{filename}/category/Computer_trace_system.rst>`_ without proper legal acts - illegally - without state court decision and notification about this. Forge brainwave fingerprints for manipulation of the investigation - and use all ability of tech for remote control of slaves and use their brainwaves and bioinformatics programs for keep victim in controled and unhealth state.

On them illegal collection of biometric, personal and sensitive data from hacked sources and government networks.
...
Maybe, after years of "war", in my case this is conflict with cults, part of them, criminals who 'crack' phones or computers can control some aspects of your physiology, psychology by brainwashing and other. And in parallel they can use low power magnetic fields for nerve or brain stimulation, because most speakers don`t has protection ( shields ) from magnetic fields, or still work this https://github.com/fulldecent/system-bus-radio. Devices have screens, speakers, microphones an microwave/radio transmitters, this devices interacts with perception and science provides to the public much knowledge about the `brain <{filename}/category/Health_Effects_in_RF_Electromagnetic_fields.rst>`_, `psychic`_ and `central nervous system`_. All described things can destroy some structures in brain and change biochemical balance and this like being dead. This biochemical changes very good described on this site: https://www.cs.cmu.edu/~dst/Library/Shelf/wakefield/us-14.html

**For self-help I can use neuroprotectors,** `melatonin`_ **, omega-3, vitamin complexes and pills for support some function of organism, like pills for people without sexual life ( love with partner to important to everyone and activate biggest part of glands of internal secretion, without that and other aspects of health life you a "rondroid" ).**
